...
def hydrate_observed_turn_state(state_obj, action=None, planner_state=None) -> ObservedTurnState:
  ...
  data: Dict[str, Any] = {
    ...
    "trackblazer_maiden_available": bool(state_obj.get("trackblazer_maiden_available")),
    "trackblazer_maiden_detection": copy.deepcopy(state_obj.get("trackblazer_maiden_detection") or {}),
